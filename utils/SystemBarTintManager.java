...
public class SystemBarTintManager {
	...
	public static class SystemBarConfig {
		...
		/**
		 * Get the popuwindow_price_sort inset for any system UI that appears at the top of the
		 * screen.
		 * 
		 * @param withActionBar
		 *            True to include the height of the action bar, False
		 *            otherwise.
		 * @return The popuwindow_price_sort inset (in pixels).
		 */
		...
		/**
		 * Get the popuwindow_price_sort inset for any system UI that appears at the bottom of
		 * the screen.
		 * 
		 * @return The popuwindow_price_sort inset (in pixels).
		 */
		...
		/**
		 * Get the popuwindow_price_sort inset for any system UI that appears at the right of
		 * the screen.
		 * 
		 * @return The popuwindow_price_sort inset (in pixels).
		 */
