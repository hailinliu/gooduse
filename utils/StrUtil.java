...
public final class StrUtil {
    ...
    public static boolean IsMyMa(String a, String b) {
        String[] split = a.split("\\=");
        String md5Encode = MD5Util.MD5Encode(split[0], "runtaids");
        if (md5Encode != null && md5Encode.equals(a)) {
     ...
     * 设置edittext光标在内容后面
     */
    public static void setCursorAfter(EditText et) {
        Editable etext = et.getText();
        Selection.setSelection(etext, et.length());
    }
